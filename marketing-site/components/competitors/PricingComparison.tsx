    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="relative rounded-lg border-2 border-green-500 bg-white p-6 shadow-lg">
          ...
          <div className="mt-2">
            <h3 className="text-xl font-bold text-gray-900">{upstream.cxpany.name}</h3>
      ...
      <div className="rounded-lg border border-gray-300 bg-gray-50 p-6">
        ...
        <div className="mt-4 text-sm text-gray-600">
          <p className="flex items-start gap-2">
            <Info className="h-4 w-4 mt-0.5 flex-shrink-0" />
            <span>
              {upstream.cxpany.name}'s fixed pricing enables predictable annual budgeting.{' '}
